...
@Service
public class DecrementProductStockCommandHandler implements CommandHandler<DecrementProductStockCommand, Void> {

    private final ProductRepository productRepository;
    private final ApplicationEventPublisher eventPublisher;

    public DecrementProductStockCommandHandler(ProductRepository productRepository,
    ...
    @Override
    @Transactional
    public Void handle(DecrementProductStockCommand command) {
